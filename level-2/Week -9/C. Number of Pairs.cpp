...
void solve(int testcase)
{
    ...
    sort(all(a));
    int ans = 0;
    auto fnd = [&](vector<int> a, int mark)
    {
        int i = 0;
        int j = n - 1;
        int ans = 0;
    ...
    cout << fnd(a, r) - fnd(a, l - 1) << endl;
}
/* stuff you should look for
 * sbse pehle question dobara padho sir
 * lower_bound gives the first val that is greter than or equal to the val
 * upper_bound gives the first val that is greater than the val
